...
const WORKOUT_PLAN_VERSION = "beast-variation-1-v4";
...
function buildAdvancedBodybuildingDays(
  ...
  return [
    buildDay("day-1", "Mon: Chest + Back + Abs", "Beast Chest + Back", "Advanced 60-75 minute muscle-build day. Pyramid your early sets, use clean reps, and let the final quality set on pulls approach failure when called for. Scale volume down if recovery slips.", chestBackOne, {
    ...
    buildDay("day-2", "Tue: Shoulders + Arms + Forearms + Abs", "Beast Arms + Delts", "High-volume advanced upper-body work. Keep isolation strict, respect the short rests, and stop only when form starts to break. Scale volume if elbows or shoulders stop recovering.", shouldersArmsOne, {
    ...
    buildDay("day-3", "Wed: Legs + Lower Back + Abs", "Beast Legs + Foundation", "This is the lower-body and lower-back day. Keep the hinges disciplined, let squats own the session, and scale volume if lower-back recovery suffers.", legsOne, {
    ...
    buildDay("day-4", "Thu: Chest + Back + Abs", "Beast Chest + Back", "Repeat the Beast chest and back pattern with steady quality and controlled fatigue management. Split the final pairing apart if your hinge position degrades.", chestBackTwo, {
    ...
    buildDay("day-5", "Fri: Shoulders + Arms + Forearms + Abs", "Beast Arms + Delts", "Repeat the Beast shoulder and arm volume with strict execution and controlled near-failure effort. Pull volume down before your joints get cranky.", shouldersArmsTwo, {
    ...
    buildDay("day-6", "Sat: Legs + Lower Back + Abs", "Beast Legs + Foundation", "Finish the week with disciplined leg and lower-back work before a full Sunday rest. Keep the last third of the session strict instead of sloppy.", legsTwo, {
