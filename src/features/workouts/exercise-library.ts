...
const brandedExerciseNames: Partial<Record<string, string>> = {
  ...
  "standing-chest-fly": "Wing Expansion",
...
const detailedEntries: ExerciseMetadata[] = [
  ...
  createExerciseMetadata("Standing chest fly", {
    shortDescription: "A standing cable-based chest fly that keeps tension on the pecs through the full arc.",
    stepByStepInstructions: [
      "Set the cable handles slightly below shoulder height and stand tall in the middle.",
      "Sweep the handles together in front of the chest with a soft elbow bend.",
    ...
    workoutLocation: ["gym"],
    tips: ["Keep the rib cage stacked while you squeeze inward.", "Move through a smooth arc instead of turning it into a press."],
    commonMistakes: ["Shrugging through the finish.", "Using too much load to control the stretch."],
    substitutions: [
      { type: "same-pattern-option", name: "Chest fly", reason: "Keeps the same chest isolation pattern in a bench-based setup." },
      { type: "gym-alternative", name: "Resistance band chest press", reason: "Still lets you load the chest with simple setup." },
      { type: "easier-option", name: "Push-up", reason: "Gives a simpler chest-focused movement when cables are not open." },
    ],
  }),
